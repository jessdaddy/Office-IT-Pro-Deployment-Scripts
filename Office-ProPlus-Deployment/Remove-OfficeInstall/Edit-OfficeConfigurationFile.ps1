...
$ConfigFile.Configuration.Add.RemoveAttribute("Version")
#$ConfigFile.Configuration.Updates.RemoveAttribute("Version")
$nodes = $ConfigFile.GetElementsByTagName("Updates")
foreach($node in $nodes){
$node.RemoveAttribute("TargetVersion")
}
if($TargetFilePath){
Format-XML $ConfigFile.OuterXml | Out-File -FilePath $TargetFilePath
}
}
} 
