...
Generate-ODTConfigurationXml -Languages AllInUseLanguages -TargetFilePath $targetFilePath | Set-ODTAdd -Version $version | Remove-OfficeInstall | Install-OfficeClickToRun -OfficeVersion Office2016
