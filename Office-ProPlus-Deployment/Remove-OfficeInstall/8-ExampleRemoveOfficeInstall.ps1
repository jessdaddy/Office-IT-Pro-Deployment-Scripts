...
Generate-ODTConfigurationXml -Languages AllInUseLanguages -TargetFilePath $targetFilePath | Set-ODTAdd -Version $version | Nuke-Office | Install-OfficeClickToRun -OfficeVersion Office2016
